...
DD_PAUSE  = {"A": 0.20, "C": 0.20, "D": 0.20, "E": 0.20, "F": 0.20}
DD_RESUME = {"A": 0.12, "C": 0.12, "D": 0.12, "E": 0.12, "F": 0.12}

# 各策略最大同時持倉 (持有期越長需要越多槽)
MAX_POS = {"A": 8, "C": 8, "D": 8, "E": 8, "F": 8}
...
def collect_signals(data, strategy_key):
    ...
    needs_rs = strategy_key in ("A", "C", "D", "E")  # F uses no RS rank
